        ...
        <>
            ...
            <footer className="w-100 bg-dark">
                <div className="container mt-5">
                    <div className="row">
                        <div className=" col-lg-2 col-md-2 col-sm-2 text-light my-5 mx-auto">
                            <h3>ABOUT COCOTOURS</h3>
                            <p>
                                cocotours operates within a wide network largely based in South India, with its services varying from crafting
